    ...
    install(pluginFunctions) {
      usePdfViewerStore.setState({
        pluginFns: {
          ...
          jumpToPreviousPage: pluginFunctions.jumpToPreviousPage.bind(pluginFunctions),
          zoom: (scale: number) => pluginFunctions.zoom(scale),
          enterFullScreenMode: pluginFunctions.enterFullScreenMode.bind(pluginFunctions),
          exitFullScreenMode: pluginFunctions.exitFullScreenMode.bind(pluginFunctions),
