...
export function PdfAppLayout({ pdfArea, pdfId, onPdfSelect, onPdfDelete }: PdfAppLayoutProps) {
  ...
  return (
    <div className="flex h-screen flex-col bg-background">
      <div className="flex flex-1 overflow-hidden">
        ...
        >
          ...
          {leftOpen && (
            <div className="flex flex-1 flex-col overflow-auto p-2">
              <LeftSidebar onPdfSelect={onPdfSelect} onPdfDelete={onPdfDelete} />
              <Button
                variant="ghost"
                size="sm"
                className="mt-auto"
        ...
        <LLMSettingsSheet open={settingsOpen} onClose={() => setSettingsOpen(false)} />
          ...
          <div className="flex h-12 items-center justify-between border-b border-border px-2">
            <div className="flex items-center gap-2">
              <Button
                ...
                aria-label={rightOpen ? '右サイドバーを閉じる' : '右サイドバーを開く'}
              >
                <Menu className="h-5 w-5" />
              </Button>
              {rightOpen && (
